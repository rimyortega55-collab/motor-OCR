...
from motor_ocr.layout.bbox import desnormalizar_bbox, normalizar_bbox  # noqa: E402
from motor_ocr_api import almacen  # noqa: E402
...
def base_limpia():
    init_db()
    # El limitador de tasa cuenta por proceso: sin resetearlo, una suite que
    # llama varias veces a un endpoint limitado agota la cuota y las pruebas
    # siguientes reciben 429.
    limites.limpiar()
    with session_scope() as sesion:
        for modelo in (DecisionAlmacenada, BloqueAlmacenado, DocumentoAlmacenado):

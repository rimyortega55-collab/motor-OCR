...
def encolar(documento_id: str, contenido: bytes, usuario_id: str) -> None:
    """Arranca el procesamiento en segundo plano y vuelve enseguida."""

    hilo = threading.Thread(
        target=_procesar,
        args=(documento_id, contenido, usuario_id),
...
def _procesar(documento_id: str, contenido: bytes, usuario_id: str) -> None:
    ...
    try:
        ...
        with session_scope() as sesion:
            ...
            _persistir_costos(sesion, usuario_id, documento_id, documento_ocr.documento_id)
        ...
        # usuario necesita ver que su envío se procesó y con qué error.
        with session_scope() as sesion:
            registro = sesion.get(DocumentoAlmacenado, documento_id)
...
def _persistir_costos(sesion, usuario_id: str, documento_id: str, documento_interno_id) -> float:

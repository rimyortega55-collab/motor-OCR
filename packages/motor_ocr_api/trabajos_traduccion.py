...
El costo se registra lote a lote y no al final: si el trabajo se corta a la
mitad, lo gastado hasta ahí ya queda atribuido al documento, sin depender de
que el resto del lote termine.
"""
...
from motor_ocr.traduccion import ContextoTraduccion, bloques_a_traducir, traducir_lote
from motor_ocr.traduccion.cliente import armar_lotes

...
- **Espacio, otra vez.** Quien procesa el documento tiene que poder borrarlo
  cuando ya no lo necesita. Un borrado que deja el PDF en disco no es un
  borrado.
...
from motor_ocr_api.persistencia import DocumentoAlmacenado, session_scope
